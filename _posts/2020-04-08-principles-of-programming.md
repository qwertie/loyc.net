...
- Macro-based languages for code generation (Rust, Clojure, [Sweet.js](https://www.sweetjs.org/) for JavaScript, [LeMP](ecsharp.net/lemp/) for C#, and please contact me personally for help with the latter)
- [LES2](loyc.net/les/), which is JSON-compatible, for storing data that contains code-like entities such as [expressions](https://en.wikipedia.org/wiki/Expression_(computer_science))
